...
#' Reference Index
#' 
#' Extract the index used as a reference for generating position
#' vectors.
#' 
#' @param x Object
...
#' Extract Index
#' 
#' Extract the index for a particular dimension in a ledger
#' from a ledger or from an object containing one or more ledgers.
#' 
#' @param x Object
...
#' Position Vectors
#' 
#' Return an integer vector of positions of \code{x} in
#' \code{table}. Currently this is a simple wrapper around
#' \code{\link{match}}.
#' 
...
#'
#' @param x An index with columns to be renamed.
