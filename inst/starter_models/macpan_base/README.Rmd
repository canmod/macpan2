...
To further prepare the time series data for calibration we filter for the appropriate time range and time series variables, to create a numeric date field named 'time'.
```{r prep_ts}
