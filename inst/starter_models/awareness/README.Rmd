...
This model is particularly interesting for small populations if we use the [`mp_euler_multinomial`](?mp_euler_multinomial()) state update method to generate process error from the Euler multinomial distribution.
