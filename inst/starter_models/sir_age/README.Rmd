---
title: "SIR with Age-based Transmission"
index_entry: "An SIR model with age-based transmission"
...
This is an extension of the [sir](https://github.com/canmod/macpan2/tree/main/inst/starter_models/sir) model that includes age-based transmission, based off of the model presented in [@Mistry2021].
...
In this age structured model, each state is a vector with one entry per age group. 

The size of the population in each age groups is $N = S + I + R$.

# Parameters

| variable | description                  |
| -------- | ---------------------------- |
| $\tau$  | transmissibility (proportion of contacts with infecteds that yield infection) |
