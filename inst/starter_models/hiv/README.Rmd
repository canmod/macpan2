...
This positive correlation makes some sense given that the [force of infection](#force-of-infection) is an increasing function of `lambda0` and a decreasing function of `alpha`.
