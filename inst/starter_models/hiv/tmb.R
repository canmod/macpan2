...
flows = list(
  ...
  , mp_per_capita_flow("I2", "A2", "tau", "protection1")
  , mp_per_capita_flow("I3", "A3", "tau", "protection1")
  , mp_per_capita_flow("I4", "A4", "tau", "protection1")
  , mp_per_capita_flow("A1", "I1", "phi", "waning1")
  , mp_per_capita_flow("A2", "I2", "phi", "waning2")
  , mp_per_capita_flow("A3", "I2", "phi", "waning3")
  , mp_per_capita_flow("A4", "I2", "phi", "waning4")
