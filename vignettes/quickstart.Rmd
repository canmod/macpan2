...
Currently `macpan2` does not have any way to explicitly specify the physical time unit (e.g. 1 day) associated with a single time-step. It is up to the user to provide such an interpretation. We do plan to allow the user to provide time units, but this functionality is not yet developed.
