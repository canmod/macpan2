...
This quickstart guide is meant to show a new user how to specify and simulate a simple compartmental model in `macpan2`, which can be [installed like this](https://github.com/canmod/macpan2/#installation).
...
In this article, we work through the specification and simulation of the SIR sample model. You can discover [more examples here](https://canmod.github.io/macpan2/articles/example_models).
