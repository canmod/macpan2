...
- harmonize presentation with quickstart
...
- `time`: An internal time index, where `time = 0` corresponds to the user-provided values (initial conditions). [SW: note that the default now more intuitively starts at time = 1]
