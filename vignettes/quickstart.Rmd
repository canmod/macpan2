...
This vignette shows how to simulate from the SI model, which is I think is the simplest possible model of epidemiological transmission. Here is the code for defining an SI model (see [this short article](#example_models) on how to find other example models).
```{r hello-world}
library(macpan2)
