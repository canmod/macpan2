...
(Note that the `row` and `col` placeholders can be completely omitted by using `options(macpan2_collapse_traj = TRUE)` near the top of your script that calls `mp_trajectory()`)
