...
spec = (
  ...
  ## update the spec to include a new variable named 'my_var' to serve as
...
cal = mp_tmb_calibrator(
  ...
  , data
  , traj = "infection"
    ## we set the `sd` argument to 'my_var' (fit or no_fit?)
  , par = list(beta = mp_normal(location = 0.35, sd = mp_nofit("my_var"))
      ## setting a prior on 'my_var'
...
## my_var is incorrectly added twice to params_table
mp_tmb_coef(cal)
