...
There are other operations on model space besides model products. Another such operation is to convert a single compartment into several compartments. An example of this operation is breaking the infectious compartment into several symptomatic states. In this case we might want to  each of which could have different degrees of infectiousness.
```{r echo = FALSE}
EpiSymp = data.frame(
  ...
  Type = c("", "", "component", "component", "vector", "effective", rep("", 5L), "component", "component", "vector", "")
)
EpiSymp
```
...
```{r eval = FALSE}
list(
  group_partition = "Epi.Type",
  group_names = c("I.vector", "infectiousness.vector"),
