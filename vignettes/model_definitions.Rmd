...
We have another data frame, `flows`, with rows describing how individuals flow between pairs of compartments. There are four required columns in this data frame, `from`, `to`, `flow`, and `flow_type`. 
