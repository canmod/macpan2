...
```
Notice the `"Shape"` partition that identifies the shape of the variable -- in this case either `"scalar"` or `"vector"`. The vector-valued variable collects 
```{r eval = FALSE}
list(
  group_partition = "Epi",
  group_names = "C",
