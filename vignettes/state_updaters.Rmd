---
title: "Alteratives to Euler Steps"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Alteratives to Euler Steps}
...
(trajectory_comparison
  |> ggplot()
  + geom_line(aes(time, value, colour = update_method))
)
```
