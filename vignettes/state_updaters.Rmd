...
The probability of staying in the $i$th box through an entire time-step is assumed to be the following.
...
* Individuals leave the box according to a Poisson process with rate $\sum_j r_{ij}$.
* The $r_{ij}$ are held constant throughout the entire time-step, although they can change when each time-step begins.
