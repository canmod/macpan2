...
**experimental** confidence intervals (first plot requires most recent macpan2). While this code isn't horribly complex, hopefully it will all be somewhat more streamlined/automated in the future. Computing confidence or prediction intervals is a fairly big subject; see Bolker (2008) chapter 7 for an introduction to some of the issues
...
sim_ensemble <- apply(parvals, 1, function(p) sir_simulator$report(p, .phases = "during")$value) ## 48 x 1000
...
- examples of priors/regularization??
- examples of adding accumulator compartment and computing/matching to incidence
...
- *intermediate* examples 
   ...
   - fitting prevalence/hospitalization/death
   - fitting multiple data streams ...
