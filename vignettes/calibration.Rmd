...
Here is a reasonably difficult problem -- fit an SIR model to measles incidence data from London UK.
...
measles$date = ymd(paste(
  measles$year, measles$month, measles$day, sep = "-"
))
