...
We can print the results of the optimizer (`nlminb` in this case) using the `mp_optimizer_outut` function. **Always check the value of the convergence code** (if it's not 0, then something *may* have gone wrong ...).
