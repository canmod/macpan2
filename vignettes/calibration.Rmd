...
Another sanity check: make sure that the starting values give a reasonable-looking trajectory.

```{r plot1}
(sir_simulator$report(c(0,1)) |>
...
Setting $\log(\beta)=0$ instead gives us a trajectory that is still very unrealistic (the peak of our observed prevalence is only 16.7).
