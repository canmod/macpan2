...
## n.b. need strip.white = TRUE here
params <- read.delim(sep = "|", header = TRUE,
                     strip.white = TRUE,
                     ## don't think this is necessary but trying
                     ## it to see if it fixes issues ...
...
It's always a good idea to do some quick sanity checks on the objective function before you try to optimize: do you get finite values? Does changing the inputs change the returned value?
