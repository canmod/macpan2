...
There are three things that you can do with the items on this list: reading them, using them, and modifying them.

## Reading Examples

Suppose that we want to read the first `sir` example we would go here: [https://github.com/canmod/macpan2/tree/main/inst/starter_models/sir](https://github.com/canmod/macpan2/tree/main/inst/starter_models/sir). If you want to see another model then just switch `sir` to another entry in the `dir` column of the table printed above.
