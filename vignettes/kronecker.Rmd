...
We now initialize the state vectors `S` (susceptible) and `I` (infectious) over the stratification dimensions.
...
B_age = beta * contact_matrix * (susceptibility_age %x% infectivity_age)
